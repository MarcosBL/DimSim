 ...
 *
 */
public class JSONReturnUrlReader
{
	 ...
	 */
	public	JSONReturnUrlReader(String url)
	{
		this.url = url;
		this.handler = new NoOpResponseTextHandler();
	}
	public	JSONReturnUrlReader(String url, ResponseTextHandler handler)
	{
		this.url = url;
	...
	{
		return JSONReturnUrlReader.busy;
	}
