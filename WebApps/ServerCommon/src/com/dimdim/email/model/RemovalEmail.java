 ...
 */
public class RemovalEmail	implements	InvitationEmail
{
	...
	protected	ArrayList	cancelledEmails;
...
//	  	"Personal message from CONFERENCE_ORGANIZER: </font></td></tr>";
	...
	public	RemovalEmail(ConferenceInfo conferenceInfo,
			ArrayList removedEmails, String message, boolean scheduledConference,
			Locale locale, ILocaleManager localeManager, String role)
	{
		this.conferenceInfo = conferenceInfo;
		this.cancelledEmails = removedEmails;
		...
		subject = localeManager.getResourceKeyValue("email","ui_strings",this.locale,"subject.removal", role);
	...
	private	String	formatMailText(ConferenceInfo ci, String msg)
	{
		...
		try
		{
			str = localeManager.getHtmlFileBuffer("email","removal_email_template",locale, role);
			//str="test message....";
		...
		{
			System.out.println("Email Removal: From Template");	
			String headingComment = localeManager.getResourceKeyValue("email","ui_strings",this.locale,"removal_comment", role);
			...
			String str5 = str31.replaceAll("CONFERENCE_AGENDA",ci.getAgenda());
			String str6 = str5.replaceAll("CONFERENCE_TIME",ci.getStartTime());
			String str4 = str6.replaceAll("BASE_WEBAPP_URL",baseWebappURL);
	...
	public ArrayList getCancelledEmails()
	{
		return cancelledEmails;
	}
	public void setCancelledEmails(ArrayList cancelledEmails)
	{
		this.cancelledEmails = cancelledEmails;
	}
