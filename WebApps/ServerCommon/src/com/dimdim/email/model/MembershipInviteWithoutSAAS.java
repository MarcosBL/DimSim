...
public class MembershipInviteWithoutSAAS extends PasswordRecovery{
...
//	  	"Personal message from CONFERENCE_ORGANIZER: </font></td></tr>";
	...
	public	MembershipInviteWithoutSAAS(String email, String newPassword,String userName, String free_paid,
	...
	private	String	formatMailText()
	{
		...
		try
		{
			str = localeManager.getHtmlFileBuffer("email","membership_enterprise_invite_template",locale, role);
			//str="test message....";
