...
<table width="100%" cellmargin="5" cellpadding="5">
  <tr><td><h3>Cached Session Strings</h3></td></tr>
  <tr><td>
    <table cellmargin="5" cellpadding="5">
<%
	HashMap sessions = UIDataManager.getUIDataManager().getSessionStrings();
	if (sessions.size() > 0)
	{
%>
	...
	break;
			...
			try
			{
				if (key != null)
				{
					...
					SessionDataString usd = (SessionDataString)value;
					Date ct = new Date();
...
if (it > (2*60*60*1000))
{
	remove = "<a href=\"/dimdim/jsp/admin/CachedSessionStrings.jsp?removeKey="+key+"\">remove</a>";
}
%>
