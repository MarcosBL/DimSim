 ...
 * 
 * This interface provides the streaming control as well as resource management.
 * It keeps track of number of currently enabled audios and if presenter
 * video is currently active or not.
 */

public interface IAudioVideoManager
{
	/**
	...
	public	void	startAVStreaming(IConferenceParticipant presenter, String streamId, String profile, String width, String height);
