 ...
 */
public class RemoveParticipantAction	extends	ConferenceAction
{
	protected	String	userId;
	
	public	RemoveParticipantAction()
	{
	}
	public	String	doWork()	throws	Exception
	{
		...
		try
		{
			if (userId != null)
			{
				IConferenceParticipant other = conf.getParticipant(userId);
				if (other != null)
				{
					conf.ejectUserFromConference(other);
				}
			}
		}
