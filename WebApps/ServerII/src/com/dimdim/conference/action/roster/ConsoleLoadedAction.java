 ...
 */
public class ConsoleLoadedAction	extends	HttpAwareConferenceAction
{
	public	ConsoleLoadedAction()
	{
	}
	public	String	doWork()	throws	Exception
	{
		...
		if (conf != null)
		{
			...
			PortalServerAdapter.getAdapter().reportUserConsoleLoaded(conf.getConfig().getConferenceKey(), user.getId());
		}
		else
		{
			ret = ERROR;
