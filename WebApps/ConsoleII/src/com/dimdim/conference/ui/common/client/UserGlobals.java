...
public class UserGlobals
{
	...
	public	static	final	String	BeRightBack =	"be_right_back";
	...
	public	UserGlobals()
	{
		...
		this.moods.addElement(new UserMood("agree",
				ConferenceGlobals.getDisplayString("attendee_mood.agree","Agree"),
				"mood-available-label", "mood-image"));
		this.moods.addElement(new UserMood("disagree",
				ConferenceGlobals.getDisplayString("attendee_mood.disagree","Disagree"),
				"mood-available-label",  "mood-image"));
		this.moods.addElement(new UserMood("be_right_back",
				ConferenceGlobals.getDisplayString("attendee_mood.be_right_back","Be Right Back"),
				"mood-available-label",  "mood-image"));
		this.moods.addElement(new UserMood("busy",
				ConferenceGlobals.getDisplayString("attendee_mood.busy","Busy"),
				"mood-available-label",  "mood-image"));
		this.moods.addElement(new UserMood("problem",
				ConferenceGlobals.getDisplayString("attendee_mood.problem","Problem"),
				"mood-available-label",  "mood-image"));
	...
	public	boolean	isMoodStandard(String mood)
	{
		...
		if (mood.equals(UserGlobals.WaitingInLobby) ||
			...
			mood.equals(UserGlobals.Agree) ||
			mood.equals(UserGlobals.Disagree) ||
			mood.equals(UserGlobals.BeRightBack) ||
			mood.equals(UserGlobals.Busy) ||
			mood.equals(UserGlobals.Problem)) 			
		{
			b = true;
		}
		return	b;
	...
	public	String	getMoodStyleName(String mood)
	{
		...
		else if (mood.equals(UserGlobals.Agree))	{	return	"mood-agree";	}
		else if (mood.equals(UserGlobals.Disagree))	{	return	"mood-disagree";	}
		else if (mood.equals(UserGlobals.BeRightBack))	{	return	"mood-be-right-back";	}
		else if (mood.equals(UserGlobals.Busy))	{	return	"mood-busy";	}
		else if (mood.equals(UserGlobals.Problem))	{	return	"mood-problem";	}
		else if (mood.equals(UserGlobals.Question))	{	return	"mood-question";	}
...
//		return	"Only the active presenter can upload presentations and share desktop. If you wish to do so please request the current active presenter to pass control to you.";
	...
	public	String	getRoleNameText(UIRosterEntry user)
	{
		if (UIGlobals.isAttendee(user))
		{
			return	"Attendee";
		}
		else
