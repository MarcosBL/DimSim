...
public class DmFlashWidget2	//extends	ComplexPanel
{
	/*
	...
	private DmFlashWidget2(String id, String name,
...
//		Window.alert("14");
	...
	private	native void annotationMessage(String nodeId, String message)/*-{
		
		$wnd.sendAnnotationMessageInFlash(nodeId,message);
	...
	public	void	show()
	{
		try
		{
			this.startMovie(m_contentDiv, swfUrl, name, height, width, "9", color);
		}
		catch(Exception e)
		{
//			DebugPanel.getDebugPanel().addDebugMessage(e.getMessage());
		}
	}
...
//			DebugPanel.getDebugPanel().addDebugMessage(e.getMessage());
	...
	public	void	sendAnnotationMessage(String nodeId, String message)
	{
		try
		{
			this.annotationMessage(nodeId, message);
		}
		catch(Exception e)
		{
//			DebugPanel.getDebugPanel().addDebugMessage(e.getMessage());
