...
*/
public class SelectPPTFileDialogue  {
	
/*
	extends SelectOnlyApplicationFileDialog{
	protected	CommandURLFactory		commandsFactory = new CommandURLFactory();
	protected	PPTUploadPanel 	newPPTUploadPanel;
	
	public SelectPPTFileDialogue(String applicationName, String applicationType, ResourceSharingController sharingController, String DOCType, String docType) {
		super(applicationName, applicationType, sharingController, DOCType, docType);
...
//		selectFileForm.add(type);
		...
		newPPTUploadPanel = new PPTUploadPanel(
				"http://"+ConferenceGlobals.dmsServerAddress,
				ConferenceGlobals.getConferenceKey(),
				this, sharingController, docType, docType, DOCType);
...
//			hide();
	...
	public	void	onClick(Widget w)
	{
		...
		{
			//Window.alert("clicked cancle button...");
