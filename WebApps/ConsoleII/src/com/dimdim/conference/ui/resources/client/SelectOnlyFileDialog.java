...
public class SelectOnlyFileDialog	extends	CommonModalDialog	implements	ClickListener
{
	...
	public	SelectOnlyFileDialog(ResourceSharingController sharingController)
	{
		super(ConferenceGlobals.getDisplayString("resource.ppt.select.label","Upload Document"));
