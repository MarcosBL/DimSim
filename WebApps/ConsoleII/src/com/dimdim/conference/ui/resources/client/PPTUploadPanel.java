...
public class PPTUploadPanel	{

	/*
extends	Composite implements PPTConversionStartListener,
...
//	private	static	final	int	WAITING_FOR_PREPARATION	=	4;
	...
	protected	String	fileTypeDescription = "powerpoint presentation";
	...
	protected	SelectPPTFileDialogue	dialog;
...
//	protected	ProgressBar	conversionProgressBar;
	...
	public PPTUploadPanel(String dmsUrl, String meetingId,
			SelectPPTFileDialogue dialog, ResourceSharingController sharingController,
			String docType, String fileType, String fileTypeDescription)
	{
...
//		progressCommonWaitMessage.setWordWrap(true);
		...
		int sec = seconds % 60;
		progressMessageLabel.setText(ConferenceGlobals.getDisplayString("console.ppt.upload.progress","Uploading presentation:"));
		this.progressMessage.setText(min+":"+sec+" min");
//		this.setProgress(uploadProgress);
	}
...
//				if (selectedFileName.toLowerCase().endsWith(this.fileType))
				...
				{
					this.showErrorMessage("The file must be a "+this.fileTypeDescription+".");
				}
			}
			else
			{
				this.showErrorMessage("You must select a "+this.fileTypeDescription+" file to upload.");
			}
		}
	}
...
//		this.browseButton.setEnabled(true);
	...
	{
		//Window.alert("in cobnversion check response text = "+responseText);
		int error = 7500;
