...
public class MeetingLobbyTaskPropertiesProvider extends DefaultListEntryPropertiesProvider
	implements ListPropertiesProvider
{
	...
	public	MeetingLobbyTaskPropertiesProvider(UIRosterEntry me, UserRosterManager userRosterManager)
	{
		this.me = me;
		this.userRosterManager = userRosterManager;
	}
	public	MeetingLobbyTaskPropertiesProvider(UIRosterEntry user,
	...
	public ListEntryPropertiesProvider getListEntryPropertiesProvider(UIObject object)
	{
		...
		return new MeetingLobbyTaskPropertiesProvider(user,me,userRosterManager,listPanel);
	}
	...
	{
		return	UIImages.getImageBundle(UIImages.defaultSkin).getGrantEntryTaskImageUrl();
	}
	public Image getImage3Url()
	{
		return	UIImages.getImageBundle(UIImages.defaultSkin).getDenyEntryTaskImageUrl();
	}
	
	public String getImage2Tooltip()
	{
		return UIStrings.getAcceptLabel();
	}
	public String getImage3Tooltip()
	{
		return UIStrings.getDenyLabel();
	}
}
