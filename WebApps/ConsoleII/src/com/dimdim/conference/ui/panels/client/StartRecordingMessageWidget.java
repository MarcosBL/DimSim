...
public class StartRecordingMessageWidget extends VerticalPanel
{
	public	StartRecordingMessageWidget()
	{
		Label line1 = new Label("Recording is now starting up.");
		...
		Label line2 = new Label("Please wait...");
