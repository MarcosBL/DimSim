...
public class StopRecordingQuestion3Widget extends VerticalPanel
{
	public	StopRecordingQuestion3Widget()
	{
		Label line1 = new Label("You have chosen to not save your recording.");
		...
		Label line2 = new Label("Are you sure?");
