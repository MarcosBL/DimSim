...
public interface CoBrowseModelListener	extends	FeatureModelListener
{
	...
	//public	void	onScroll(UICobrowseControlEvent event);
	...
	//public	void	onNavigation(UICobrowseControlEvent event);
}
