...
UINT
vncEncodeTight::EncodeRect(BYTE *source, CurlSocket *outConn, BYTE *dest,
...
UINT
vncEncodeTight::EncodeRectSimple(BYTE *source, CurlSocket *outConn, BYTE *dest,
								 const RECT &rect)
{
...
UINT
vncEncodeTight::EncodeSubrect(BYTE *source, CurlSocket *outConn, BYTE *dest,
