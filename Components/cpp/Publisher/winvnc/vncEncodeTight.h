...
public:
	...
	virtual UINT EncodeRect(BYTE *source, CurlSocket *outConn, BYTE *dest, const RECT &rect, int offx, int offy);
...
protected:
	...
	UINT EncodeRectSimple (BYTE *source, CurlSocket *outConn, BYTE *dest,
						   const RECT &rect);
	UINT EncodeSubrect    (BYTE *source, CurlSocket *outConn, BYTE *dest,
